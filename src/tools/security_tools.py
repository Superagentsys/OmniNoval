...
class SecurityToolManager:
    ...
    def _build_default_tools_config(self) -> Dict[str, Dict[str, Any]]:
        ...
        return {
            ...
            # --- Web Security Tools ---
            "nuclei": {"binary": "nuclei", "description": "基于模板的漏洞扫描器", "category": "web"},
            ...
            "trivy": {"binary": "trivy", "description": "容器漏洞扫描器", "category": "cloud"},
            ...
            "theharvester": {"binary": "theHarvester", "description": "OSINT 信息收集工具", "category": "osint"},
